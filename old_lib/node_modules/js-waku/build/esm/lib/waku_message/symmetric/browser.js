...
var Algorithm = { name: 'AES-GCM', length: 128 };
if (subtle === undefined) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, subtle
                    ...
                    return subtle.encrypt(__assign({ iv: iv }, Algorithm), cryptoKey, clearText);
                })
                    .then(Buffer.from)];
        });
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, subtle
                    ...
                    .then(function (cryptoKey) {
                    return subtle.decrypt(__assign({ iv: iv }, Algorithm), cryptoKey, cipherText);
                })
                    .then(Buffer.from)];
        });
    });
