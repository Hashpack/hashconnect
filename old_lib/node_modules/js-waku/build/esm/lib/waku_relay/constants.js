 ...
 */
export var RelayCodecs = [
    '/vac/waku/relay/2.0.0-beta2',
    '/vac/waku/relay/2.0.0',
];
export var RelayPingContentTopic = '/relay-ping/1/ping/null';
/**
 ...
 */
export var RelayGossipFactor = 0.25;
/**
 * GossipsubHeartbeatInitialDelay is the short delay before the heartbeat timer begins
 * after the router is initialized.
 */
export var RelayHeartbeatInitialDelay = 100;
/**
 * RelayHeartbeatInterval controls the time between heartbeats.
 */
export var RelayHeartbeatInterval = second;
/**
 ...
 */
export var RelayPruneBackoff = minute;
/**
 ...
 */
export var RelayFanoutTTL = minute;
/**
 ...
 * below a threshold
 */
export var RelayOpportunisticGraftTicks = 60;
/**
 * RelayOpportunisticGraftPeers is the number of peers to opportunistically graft.
 */
export var RelayOpportunisticGraftPeers = 2;
/**
 ...
 */
export var RelayMaxIHaveLength = 5000;
