(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('js-waku'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define(['exports', 'js-waku', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.hashconnect = {}, global['js-waku'], global.rxjs));
}(this, (function (exports, jsWaku, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var waku;
    var messageSource = new rxjs.BehaviorSubject('');
    ...
    var initWaku = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, jsWaku.Waku.create({ bootstrap: true })];
                case 1:
                    waku = _a.sent();
                    return [4 /*yield*/, jsWaku.getBootstrapNodes()];
                case 2:
                    nodes = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, jsWaku.WakuMessage.fromBytes(payload, ContentTopic)];
                case 1:
                    wakuMessage = _a.sent();
